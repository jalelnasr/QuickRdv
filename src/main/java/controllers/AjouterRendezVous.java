...
public class AjouterRendezVous implements Initializable {
    ...
    void reserve(ActionEvent event) {
        try {
            ...
            LocalDateTime endDateTime = startDateTime.plusHours(1);// Modify as
            ...
            RendezVous rendezVous = new RendezVous(selectedDate, patientId, medecinId, consultationType, startDateTime, endDateTime);
            ps.add(rendezVous);
    ...
    private void clearFields() {
        ...
        timeComboBox.setValue(null); // Clear the time ComboBox
